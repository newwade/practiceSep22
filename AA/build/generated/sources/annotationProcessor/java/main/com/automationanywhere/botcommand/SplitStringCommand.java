...
public final class SplitStringCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(SplitStringCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    SplitString command = new SplitString();
    ...
    try {
      Optional<Value> result =  Optional.ofNullable(command.action((String)convertedParameters.get("text"),(String)convertedParameters.get("delimiter")));
